...
{	
	...
	hipLaunchKernelGGL(invert_mapping, num_blocks, num_threads, 0, 0, feature_flipped_d,feature_d,npoints,nfeatures);
		   ...
		   )
{
	...
	/* execute the kernel */
    hipLaunchKernelGGL(kmeansPoint, grid, threads , 0, 0,  feature_d,
                                      nfeatures,
                                      npoints,
                                      nclusters,
                                      membership_d,
